...
source("C:/Users/DELL/Downloads/cours_r_semaine_3/semaine3.R")  # Remplacez par le bon chemin
...
test_that("summary.commune fonctionne correctement", {
  ...
  expect_output(summary.commune(df), "Commune: Paris")  # Ensure the correct commune name is printed
})
...
test_that("summary.departement fonctionne correctement", {
  ...
  expect_output(summary.departement(df), "Département: 75")  # Ensure the correct department is printed
})
...
test_that("plot.commune fonctionne correctement", {
  ...
  expect_s3_class(plot, "gg")  # Ensure the plot is a ggplot object
})
...
test_that("plot.departement fonctionne correctement", {
  ...
  plot <- plot.departement(df)  # Generate the plot
  expect_s3_class(plot, "gg")  # Ensure the plot is a ggplot object
})
